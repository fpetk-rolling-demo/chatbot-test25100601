...
!!! info
    ...
    **Source Code Repository:** [https://github.com/fpetk-rolling-demo/chatbot-test25100601](https://github.com/fpetk-rolling-demo/chatbot-test25100601)

    **GitOps Repository:** [https://github.com/fpetk-rolling-demo/chatbot-test25100601-gitops](https://github.com/fpetk-rolling-demo/chatbot-test25100601-gitops)

# **Usage**

To access the chatbot-test25100601 application that was deployed using the Software Template, complete the following instructions:
